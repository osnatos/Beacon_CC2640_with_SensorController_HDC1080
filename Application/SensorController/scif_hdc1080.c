    /*0x0300*/ 0x6C87, 0x7081, 0x6887, 0x15C5, 0x6C87, 0x7000, 0x6887, 0x160D, 0x6C87, 0x8D47, 0x7001, 0x6887, 0x160D, 0x6C87, 0x6887, 0x15BA, 
    /*0x0320*/ 0x6C87, 0xDD40, 0xDDA0, 0xDD27, 0x5C84, 0x0001, 0x0C67, 0x086C, 0x8201, 0x0C6C, 0xADB7, 0xADB7, 0x0000, 0x0000, 0x0000, 0x0000, 
    /*0x0340*/ 0x0D9C, 0x5D9D, 0x15B5, 0x15C5, 0x799D, 0x15C5, 0xFD44, 0xFDA8, 0x15C5, 0xFD44, 0xF0FF, 0x15C5, 0x099F, 0x15BA, 0x8DB7, 0x53F4, 
    /*0x0360*/ 0x15E3, 0x670F, 0x15E6, 0x53F4, 0x15E3, 0x460F, 0x53F8, 0x15E3, 0x470F, 0xADB7, 0x460F, 0x53F4, 0x15E3, 0x670F, 0x15E6, 0x53FD, 
    /*0x0380*/ 0x15E3, 0x660F, 0x53F5, 0x15E3, 0xADB7, 0xEA00, 0xBE1B, 0xB50E, 0xFDA1, 0x8601, 0xFC00, 0xB602, 0x660F, 0x8E02, 0x460F, 0xFD47, 
    /*0x03A0*/ 0x53FA, 0x15E3, 0x670F, 0x15E6, 0x53FD, 0x15E3, 0x470F, 0x660F, 0x53F4, 0x15E3, 0x670F, 0x15E6, 0x53FA, 0x15E3, 0x2613, 0xA601, 
    /*0x03C0*/ 0xE201, 0x470F, 0xADB7, 0xD802, 0xDEFE, 0xADB7, 0x86B1, 0x51E0, 0x2713, 0xAE0B, 0x2713, 0xAE09, 0x2713, 0xAE07, 0x2713, 0xAE05, 
    /*0x03E0*/ 0x2713, 0xAE03, 0xD801, 0xBEF4, 0xE202, 0xADB7, 0x0D9C, 0x5D9D, 0x7D9E, 0x15B5, 0x15C5, 0x799D, 0x15C5, 0xEA00, 0xBE0B, 0x15AF, 
    /*0x0400*/ 0x799E, 0xF201, 0x15C5, 0x7000, 0x160D, 0x8D47, 0x8DA0, 0x7001, 0x160D, 0xFD08, 0x099F, 0x15BA, 0x8DB7, 0xEA00, 0xBE1C, 0xB50B, 
    /*0x0420*/ 0x660F, 0x53F5, 0x15E3, 0x670F, 0x15E6, 0x53FF, 0x15E3, 0xFDA1, 0x2613, 0xA601, 0xF201, 0x470F, 0x8601, 0xFC00, 0xB602, 0x660F, 
    /*0x0440*/ 0x8E02, 0x460F, 0xFD47, 0x53F9, 0x15E3, 0x670F, 0x15E6, 0x53FD, 0x15E3, 0x470F, 0xF0FF, 0xADB7, 0xFB0C, 0xEDA4, 0xEB09, 0x640B, 
    /*0x0460*/ 0xCDB1, 0xADB7
};
...
//  cfg         input       output      state       
    0x008010EA, 0x001010FA, 0x009010FC, 0x0010110E  // TaskHDC1080
};
...
void scifHdc1080ReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_HDC1080_TASK_HDC1080_TASK_ID)) {
        scifReinitIo(11, -1, 0);
        HWREG((IOC_BASE + IOC_O_IOCFG0) + pAuxIoIndexToMcuIocfgOffsetLut[11]) |= IOC_IOCFG0_HYST_EN_M;
        scifReinitIo(10, -1, 0);
        HWREG((IOC_BASE + IOC_O_IOCFG0) + pAuxIoIndexToMcuIocfgOffsetLut[10]) |= IOC_IOCFG0_HYST_EN_M;
    }
} // scifHdc1080ReinitTaskIo




/// Driver setup data, to be used in the call to \ref scifInit()
const SCIF_DATA_T scifHdc1080DriverSetup = {
...
/** \brief Starts or modifies RTC-based task scheduling tick generation
  ...
  * - \a tickStart is not in the past (prefer using \ref scifHdc1080StartRtcTicksNow() to avoid this)
...
void scifHdc1080StartRtcTicksNow(uint32_t tickPeriod) {
    ...
    scifHdc1080StartRtcTicks(((sec << 16) | (subsec >> 16)) + 8, tickPeriod);
    scifOsalLeaveCriticalSection(key);
} // scifHdc1080StartRtcTicksNow
